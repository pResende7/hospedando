	...
	theme: {
		...
		extend: {
			colors: {
				...
				// Luxury dark navy and cyan colors
				'cyan-vibrant': 'hsl(var(--cyan-vibrant))',
			...
			keyframes: {
				...
				'glow': {
					'0%, 100%': {
						boxShadow: '0 0 200px hsl(var(--cyan-vibrant) / 0.3)'
					},
					'50%': {
						boxShadow: '0 0 40px hsl(var(--cyan-vibrant) / 0.6), 0 0 60px hsl(var(--cyan-vibrant) / 0.4)'
					}
				},
				'-glowpulse': {
					'0%, 100%': {
